...
## _`git log :` просмотр коммитов, диапазоны...._
...
## _`git log :` флаги-фильтры, поиск по свойствам_
...
Но часто надо искать не по названию коммитов, а по изменениям в тексте кода.
